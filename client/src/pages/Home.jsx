...
export const Home = () => {
  ...
  // Default Comprehensive Fallback Dataset for Vignan University CSE Dept Computer Labs
  const defaultLabAssets = {
    hardware: [
      {
        ...
        specs: 'Intel Core i7 11th Gen, 32GB DDR4, 1TB NVMe SSD, Nvidia GTX 1650 4GB',
        lab: 'NB-511',
        labId: 'nb511',
        qty: 45,
        status: 'operational',
      ...
      {
        id: 'HW-002',
        code: 'VUG-CSE-GPU-204',
        name: 'HP Z2 Tower AI / ML Workstation',
        specs: 'Intel Core i9 13th Gen, 64GB DDR5, 2TB SSD, Nvidia RTX 4080 16GB',
        lab: 'NB-304',
        labId: 'nb304',
        qty: 30,
        status: 'operational',
      ...
      },
      {
        id: 'HW-003',
        code: 'VUG-CSE-SW-012',
        name: 'Cisco Catalyst 9300 48-Port Gigabit Switch',
        specs: 'Managed Layer 3 Switch, 48x 1GbE PoE+ Ports, 4x 10G Uplink',
        lab: 'Lab 33',
        labId: 'lab33',
        qty: 6,
        status: 'maintenance',
        condition: 'Needs Maintenance (Port 12 faulty)',
        lastInspected: '2026-07-30',
        icon: '🌐'
      },
      {
        id: 'HW-004',
        code: 'VUG-CSE-IOT-305',
        name: 'Raspberry Pi 4 Model B (8GB) Lab Packs',
        specs: 'ARM Cortex-A72, 8GB LPDDR4, 64GB MicroSD, GPIO Expansion Kit',
        lab: 'Lab 25',
        labId: 'lab25',
        qty: 25,
        status: 'operational',
      ...
      {
        id: 'HW-005',
        code: 'VUG-CSE-MON-114',
        name: 'Dell 27" UltraSharp 4K IPS Monitor',
        specs: '3840x2160 UHD, 99% sRGB, USB-C Hub, Height Adjustable Stand',
        lab: 'NB-511',
        labId: 'nb511',
        qty: 45,
        status: 'operational',
      ...
      {
        id: 'HW-006',
        code: 'VUG-CSE-SRV-001',
        name: 'Dell PowerEdge R750 Rack Server',
        specs: 'Dual Intel Xeon Silver 4314, 128GB RAM, 8x 2TB SAS RAID 10',
        lab: 'NB-511 Research Lab',
        labId: 'nb511_research',
        qty: 2,
        status: 'operational',
        condition: 'Excellent Condition',
      ...
      },
      {
        ...
        specs: '2.4GHz Wireless USB Nano Receiver, Full-size layout',
        lab: 'NB-304',
        labId: 'nb304',
        qty: 30,
        status: 'faulty',
        condition: 'Mouse Left-Click Unresponsive (#18)',
    ...
    electrical: [
      {
        id: 'EL-001',
        code: 'VUG-CSE-UPS-001',
        name: 'APC Smart-UPS VT 20 KVA 3-Phase Online UPS',
        specs: '20 KVA / 16 kW, 400V 3-Phase, External 32-Battery Bank Tray',
        lab: 'NB-511 Main Power Room',
        labId: 'nb511',
        qty: 2,
        status: 'operational',
        condition: 'Backup Runtime: 45 Mins (Battery Health: 94%)',
      ...
      },
      {
        id: 'EL-002',
        code: 'VUG-CSE-AC-101',
        name: 'Daikin 3.0 Ton Inverter Cassette AC Unit 1',
        specs: 'R-32 Refrigerant, 4-Way Airflow Ceiling Cassette, 5-Star Rating',
        lab: 'NB-511',
        labId: 'nb511',
        qty: 4,
        status: 'operational',
        condition: 'Cooling Temperature Target: 21°C',
      ...
      },
      {
        id: 'EL-003',
        code: 'VUG-CSE-AC-202',
        name: 'Voltas 2.0 Ton Heavy Duty Split AC Unit 3',
        specs: 'Copper Condenser, Anti-Dust Filter, Turbo Cool Mode',
        lab: 'NB-304',
        labId: 'nb304',
        qty: 4,
        status: 'maintenance',
        condition: 'Filter Cleaning & Gas Pressure Top-up Scheduled',
        lastInspected: '2026-08-04',
        icon: '💨'
      },
      {
        id: 'EL-004',
        code: 'VUG-CSE-PDB-004',
        name: 'Schneider Electric 3-Phase Power Distribution Panel',
        specs: '125A Main MCCB, 24-Way Outgoing MCB Breakers, Digital Voltmeter',
        lab: 'Lab 25',
        labId: 'lab25',
        qty: 1,
        status: 'operational',
        condition: 'Normal Load Distribution (42A per phase)',
        lastInspected: '2026-07-31',
        icon: '🔌'
      },
      {
        id: 'EL-005',
        code: 'VUG-CSE-GEN-001',
        name: 'Kirloskar 125 KVA AMF Auto Diesel Generator Line',
        specs: 'Automatic Mains Failure Switch, 300L Diesel Tank, Soundproof Canopy',
        lab: 'Vignan Block-A Electrical Yard',
        labId: 'nb511_research',
        qty: 1,
        status: 'operational',
        condition: 'Auto-Switching Latency < 6 Seconds',
        lastInspected: '2026-08-01',
        icon: '🔋'
      },
      {
        id: 'EL-006',
        code: 'VUG-CSE-SUR-108',
        name: 'Belkin 8-Socket Commercial Surge Protector Rails',
        specs: '2140 Joules Surge Protection, Heavy-Duty 3m Cord, EMI/RFI Filter',
        lab: 'Lab 33',
        labId: 'lab33',
        qty: 12,
        status: 'operational',
    ...
    furniture: [
      {
        id: 'FN-001',
        code: 'VUG-CSE-DSK-101',
        name: 'Modular 4-Seater Dual Computer Workstation Desk',
        specs: 'CRCA Steel Frame, Pre-laminated Particle Board Top, Cable Tray & CPU Cage',
        lab: 'NB-511',
        labId: 'nb511',
        qty: 12,
        status: 'operational',
        condition: 'Good Condition (Seats 48 Students)',
        lastInspected: '2026-07-20',
        icon: '🖥️'
      },
      {
        id: 'FN-002',
        code: 'VUG-CSE-CHR-105',
        name: 'Featherlite Ergonomic Revolving Mesh Chairs',
        specs: 'Pneumatic Height Adjustment, Lumbar Support, Twin Wheel Nylon Castors',
        lab: 'NB-511',
        labId: 'nb511',
        qty: 50,
        status: 'operational',
        condition: '48 Good, 2 Hydraulic Cylinders Replaced',
        lastInspected: '2026-08-02',
        icon: '🪑'
      },
      {
        id: 'FN-003',
        code: 'VUG-CSE-RCK-002',
        name: '42U Floor Standing Server & Network Enclosure Rack',
        specs: 'Glass Front Door, Perforated Rear Door, Integrated Cooling Fans, Cable PDU',
        lab: 'NB-511 Research Lab',
        labId: 'nb511_research',
        qty: 4,
        status: 'operational',
        condition: 'Excellent Lock & Ventilation',
        lastInspected: '2026-08-01',
        icon: '🗄️'
      },
      {
        id: 'FN-004',
        code: 'VUG-CSE-WBD-201',
        name: '8x4 Ft Magnetic Ceramic Steel Whiteboard',
        specs: 'Scratch-resistant ceramic coated steel, Aluminum frame, Marker tray',
        lab: 'NB-304',
        labId: 'nb304',
        qty: 2,
        status: 'operational',
        condition: 'Clean Ceramic Surface',
        lastInspected: '2026-07-15',
        icon: '📋'
      },
      {
        id: 'FN-005',
        code: 'VUG-CSE-CAB-302',
        name: 'Godrej 6-Door Heavy Steel Storage Locker Cabinet',
        specs: '1mm Thick Cold Rolled Steel, Individual Key Lock & Number Tagging',
        lab: 'Lab 25',
        labId: 'lab25',
        qty: 4,
        status: 'maintenance',
        condition: 'Locker #4 Key Cylinder Sticking',
        lastInspected: '2026-08-03',
        icon: '🗄️'
      },
      {
        id: 'FN-006',
        code: 'VUG-CSE-TBL-401',
        name: 'Anti-Static Lab Workbench Table with Overhead Shelf',
        specs: 'ESD Grounding Mat, Integrated Power Strips, High Load Capacity',
        lab: 'CSE Lab 4 (Networks & Security Lab)',
        labId: 'lab4',
        qty: 8,
        status: 'operational',
        condition: 'Excellent Condition',
